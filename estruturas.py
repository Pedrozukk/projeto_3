# ============================================================
# estruturas.py - Fila e Pilha usadas no sistema SteamPy
# ============================================================
# Este arquivo implementa as estruturas de dados obrigatorias:
# - FilaBacklog: fila (FIFO) para armazenar jogos a jogar
# - PilhaRecentes: pilha (LIFO) para armazenar jogos recentes


# -------- CLASSE FILA BACKLOG --------
class FilaBacklog:
    # Implementa uma fila FIFO para o backlog do usuario
    # Primeiro a entrar, primeiro a sair - perfeito para lista de espera

    def __init__(self):
        # Inicializa a fila vazia como uma lista Python
        self._fila = []  # lista usada como fila (FIFO)

    def enqueue(self, jogo):
        # Adiciona um jogo no final da fila (proximo a jogar depois)
        # Parametro: jogo - objeto Jogo a ser adicionado
        self._fila.append(jogo)

    def dequeue(self):
        # Remove e retorna o primeiro jogo da fila (o proximo a jogar)
        # Retorna: objeto Jogo ou None se fila vazia
        if self.is_empty():
            return None
